...
- Generación de “Demanda base”
  - Endpoints:
    ...
    - `POST /api/demanda-base/docx` → descarga `.docx` con formato profesional
  - Parámetros:
    ```json
    {
      ...
      "meta": {
        ...
        "mutua": "",
        "relacion_laboral": "Descripción de la relación laboral",
        "contingencia_evolucion": "Descripción de la contingencia y evolución",
        "actuaciones_administrativas": "Descripción de actuaciones administrativas",
        "cuadro_clinico": "Descripción del cuadro clínico y limitaciones"
      }
    }
    ```
  - Construcción del borrador:
    - Encabezado y parte: con `meta`
    - Hechos: narrativa propia usando campos de HECHOS (relación laboral, contingencia, actuaciones INSS, cuadro clínico)
  ...
  - Formato DOCX:
    - Estilos profesionales con Times New Roman
    - Formato legal con sangrías y espaciado
    - Encabezados y secciones diferenciadas
    - Márgenes y configuración profesional
